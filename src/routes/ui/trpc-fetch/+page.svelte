<script lang="ts">
	...
	import OrderSkeleton from '$components/OrderSkeleton.svelte';
	import { addToast } from '$lib/stores/toast.svelte.js';
	import { apiClient } from '$lib/trpc/client';
	import { createOrderWithMethods, type OrderWithMethods } from '$types/OrderWithMethods';
	import type { Customer, Product } from '$types/Schema';
	import { type OrderErrors, orderValidator } from '$types/Validators';
