	...
	<div class="mx-auto max-w-5xl px-4 py-16">
		...
		<div class="grid gap-6 md:grid-cols-3">
			{#each demos as demo}
				...
				>
					<div
						class="from-primary-100 absolute top-0 right-0 h-24 w-24 translate-x-8 -translate-y-8 rounded-full bg-linear-to-br to-purple-100 opacity-50"
					></div>

					<div class="relative">
						<div class="mb-4 flex items-center justify-between">
							<div class="bg-primary-100 rounded-lg p-2">
								<svelte:component this={demo.icon} class="text-primary-600 h-6 w-6" />
							</div>
		...
		<div class="mt-16 text-center">
			<p class="text-sm text-gray-500">Built with SvelteKit, tRPC, Flowbite, and svstate v1.4.0</p>
		</div>
	</div>
</div>
